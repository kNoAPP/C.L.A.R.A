...
public enum SpecialItem {
	...
	SAVE_WORLD_FALSE(ChatColor.RED + "Save World on Disable", 1, (byte)0, Material.COMMAND,
			new String[]{ChatColor.GRAY + "Save world(s) to database on disable"}, null, null),
	SAVE_WORLD_TRUE(ChatColor.RED + "Save World on Disable", 1, (byte)0, Material.COMMAND,
			new String[]{ChatColor.GREEN + "Selected!", ChatColor.GRAY + "Save world(s) to database on disable"},
			new Enchantment[]{Enchantment.ARROW_INFINITE}, new ItemFlag[]{ItemFlag.HIDE_ENCHANTS}),
